...
namespace coodroid.DAL.model
{
	...
	public partial class subjectType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "subjectType"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from subjectType");
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM subjectType ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from subjectType T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "subjectType";
