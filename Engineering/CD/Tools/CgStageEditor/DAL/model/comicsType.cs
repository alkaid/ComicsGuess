...
namespace coodroid.DAL.model
{
	...
	public partial class comicsType
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQLite.GetMaxID("id", "comicsType"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from comicsType");
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from comicsType T ");
