...
namespace coodroid.DAL.model
{
	...
	public partial class catalog
	{
		...
		public coodroid.Model.model.catalog GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name from catalog ");
			strSql.Append(" where id=@id");
			SQLiteParameter[] parameters = {
					new SQLiteParameter("@id", DbType.Int32,4)
			};
			...
			coodroid.Model.model.catalog model=new coodroid.Model.model.catalog();
		...
		/// 得到一个对象实体
		/// </summary>
		public coodroid.Model.model.catalog DataRowToModel(DataRow row)
		{
			coodroid.Model.model.catalog model=new coodroid.Model.model.catalog();
			if (row != null)
			{
